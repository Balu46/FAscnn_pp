...
\input{../rozdzialy/03_Implementacja/implementacja}
\input{../rozdzialy/04_Metodologia_Badan/metodologia_badan}
\input{../rozdzialy/05_Wyniki_Eksperymentow/wyniki_eksperymentow}
\input{../rozdzialy/06_Podsumowanie/podsumowanie}
